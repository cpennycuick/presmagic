define(['app/listable/listable'], function (Listable) {
	...
	var MAIN_DIV = "<div class ='Presentation ListPanel'>";
	var SEARCH_BOX_HTML = '<div> 							\
						<input type="Text" 				\
							id="@ID"	 			\
	...
	var BASIC_LIST_TEMPLATE = "<ul class = 'List'></ul>";
	var END_DIV = "</div>";
	...
	ListPanel.prototype._setFilterBox = function(selector) {
		...
		this.getContainer().find(this._filterBoxIdentifier)
